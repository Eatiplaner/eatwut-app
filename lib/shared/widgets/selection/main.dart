...
class Item{
  ...
  Item({this.name = "", this.value = "", this.isSelected = false, this.isEnable = true});
}
...
class _ESelectionState extends State<ESelection> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: widget.itemList.length * 35,
            ...
            child: Checkbox(
              ...
              fillColor: MaterialStateProperty.all<Color>(
                  widget.itemList[index].isEnable
                      ? primaryColor
                      : Colors.grey[100]!),
              activeColor: widget.itemList[index].isEnable
                  ? primaryColor
                  : Colors.grey,
    ...
    builder: (context) => Column(
      children: [
        ESelection(
            onOptionClick: (value) {},
            itemList: [
              Item(name: "Intermittent Fasting", value: "intermittent", isEnable: true),
              Item(name: "Mediterranean Diet", value: "mediterranean", isEnable: true),
              ...
              Item(name: "Dessert with Breakfast Diet", value: "breakfast", isEnable: true),
            ],
        ),
      ],
    ),
