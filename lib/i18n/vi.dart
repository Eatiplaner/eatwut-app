get messages => {
      ...
      'auth.register.field.label.email': 'Email của bạn là?',
      'auth.register.field.placeholder.email': 'Email của bạn',

      'auth.register.field.label.password': 'Tạo mật khẩu cho bạn nào',
      'auth.register.field.placeholder.password': 'Tạo mật khẩu',
      'auth.register.field.validation.password1':
          'Mật khẩu phải có ít nhất 8 ký tự.',
      'auth.register.field.validation.password2':
          'Mật khẩu phải kèm ký tự đặc biệt.',
      'auth.register.field.validation.password3':
          'Mật khẩu phải có 1 ký tự là số.',
      'auth.register.field.validation.password4':
          'Mật khẩu phải có 1 chữ viết hoa.',
